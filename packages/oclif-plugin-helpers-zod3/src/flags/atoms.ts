 ...
 */
export const zDateYYYYMMDD: z.ZodType<Date, z.ZodTypeDef, string> = z
  .string()
...
export const zStringList: z.ZodType<string[], z.ZodTypeDef, unknown> =
  normalizeStringList({
    dedupe: true,
  });
...
export function zInt(
  ...
  return prepped.pipe(
    z.coerce.number().finite('must be finite').int('must be an integer')
  );
}
...
export function zIntList(
  ...
  const normalizeScalarListNoCast: z.ZodType<
    (string | number)[],
    z.ZodTypeDef,
    unknown
  ...
  let perItem: z.ZodType<number, z.ZodTypeDef, string | number> = z
    .union([
      z
        .string()
 ...
 */
export const zDateComparator: z.ZodType<DateComparator, z.ZodTypeDef, string> =
  z.string().transform<DateComparator>((raw, ctx) => {
    const s = raw.trim();
 ...
 */
export const zDateComparatorList: z.ZodType<
  DateComparator[],
  z.ZodTypeDef,
  unknown
