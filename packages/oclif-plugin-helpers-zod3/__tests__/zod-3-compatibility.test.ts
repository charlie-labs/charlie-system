...
test('Zod 3 schemas retain manifest input/output inference and validation', () => {
  const typeAssertions: [...Zod3TypeAssertions, ...ManifestTypeAssertions] = [
    true,
    true,
    true,
    true,
